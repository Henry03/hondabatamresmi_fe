                    ...
                    <tbody>
                        {
                            data.map((item, index) => (
                                <tr key={item.id}>
                                    ...
                                    <td>
                                        <button className="btn btn-circle btn-text btn-sm" aria-label="Action button" onClick={()=>{fillInput(item.id, item.name, item.slug); HSOverlay.open('#tagModal')}}><span className="icon-[tabler--pencil] size-5"></span></button>
                                        <button className="btn btn-circle btn-text btn-sm" aria-label="Action button" onClick={()=>{setId(item.id); HSOverlay.open('#deleteTagModal')}}><span className="icon-[tabler--trash] size-5"></span></button>
                                    </td>
                                </tr>
                            ))
                        }
