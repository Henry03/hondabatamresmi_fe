...
function Login () {
    ...
    const handleLogin = (e) => {
        ...
        axios.post('/api/v1/auth/login', input)
            ...
            <div className="relative flex items-center justify-center px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-base-100 shadow-base-300/20 z-1 w-full space-y-6 rounded-xl p-6 shadow-md sm:min-w-md lg:p-8">
                    <div className="flex items-center gap-3">
                        <img src={hondaLogo} className="h-8" alt="brand-logo" />
                    </div>
                    <div>
                        <h3 className="text-base-content mb-1.5 text-2xl font-semibold">Sign in to Honda Resmi Batam</h3>
                        <p className="text-base-content/80">Ship Faster and Focus on Growth.</p>
                    </div>
                    <div className="space-y-4">
                        <form className="mb-4 space-y-4" onSubmit={(e)=>handleLogin(e)}>
                            <div className="">
                                <label className="label label-text" htmlFor="labelAndHelperText"> Username </label>
                                <input type="text" placeholder="Type your username" className={`input ${errors?.username ? "is-invalid" : null}`} id="labelAndHelperText" value={username} onChange={(e) => setUsername(e.target.value)}/>
                                {
                                    errors?.username &&
                            ...
                            <button className="btn btn-lg btn-primary btn-gradient btn-block">Sign in</button>
                        </form>
                        <p className="text-base-content/80 mb-4 text-center">
                            New on our platform?
                            <Link to="/auth/register" className="link link-animated link-primary font-normal">
                                Create an account
                            </Link>
                        </p>
                    </div>
